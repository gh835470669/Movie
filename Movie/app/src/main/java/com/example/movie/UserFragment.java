    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        wantToWatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isLogon) return;
                Intent intent = new Intent(UserFragment.this.getContext(), WantToWatchActivity.class);
        ...
        haveWatched.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isLogon) return;
                Intent intent = new Intent(UserFragment.this.getContext(), HaveWatchedActivity.class);
                Bundle bundle = new Bundle();
        ...
        userInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isLogon) {
                    Intent intent = new Intent(UserFragment.this.getContext(), AlterUserActivity.class);
                    Bundle bundle = new Bundle();
