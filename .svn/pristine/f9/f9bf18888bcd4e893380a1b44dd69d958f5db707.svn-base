...
//        }
//        QRCodeUtil.encode(url, "", "C:/Users/Abinlian/Desktop", true);

          
        String text = "http://103.224.81.114/load/article.do?articleId=10";
        int articleId = 10;
        QRCodeUtil.encode(text, "", "C:/Users/Abinlian/Desktop", true, articleId +".jpg");
    }
